...
"""
                ...
                def render_note_html(raw: str) -> str:
                    ...
                    html = ""
                    for i, (date, lines) in enumerate(groups.items()):
                        if i > 0:
                        ...
                        for ln in lines:
                            ...
                            if m2:
                                html += (f"<div style='padding:1px 6px;font-size:11px;'>"
                                         f"<b>{m2.group(1)}</b> : {m2.group(2)}</div>")
                            else:
                                html += f"<div style='padding:1px 6px;font-size:11px;'>{ln}</div>"
                    return html
